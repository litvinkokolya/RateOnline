...
class MemberNomination(models.Model):
    ...
    photo_1 = ResizedImageField(size=[500, 500], quality=100, null=True, blank=True)
    photo_2 = ResizedImageField(size=[500, 500], quality=100, null=True, blank=True)
    photo_3 = ResizedImageField(size=[500, 500], quality=100, null=True, blank=True)
    photo_4 = ResizedImageField(size=[500, 500], quality=100, null=True, blank=True)
